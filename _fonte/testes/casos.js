...
const CASOS = [
  ...
  { id: 'C8', titulo: 'Grávida, suspeita de TEP, YEARS 0, D-dímeros 0,85',
    ...
    passos: [["card","Suspeita de TEV"],["click","TEP"],["click","Não, estável"],["click","Ir para a via da grávida"],["click","Não"],
  ...
  { id: 'C10', titulo: 'TVS da grande safena, 8 cm, a 6 cm da junção',
    ...
    passos: [["card","TEV confirmado"],["click","TVP"],["click","Trombose venosa superficial"],["click","≥5 cm de extensão"],["click","Fondaparinux"]] },
  ...
  { id: 'C16', titulo: 'TVP proximal em doente já anticoagulado (falência)',
    ...
    passos: [["card","TEV confirmado"],["click","TVP"],["click","TVP proximal"],["click","Tratar em ambulatório"],["click","Já estava anticoagulado"],["fill","pw","70"],["btnin","hbpmbtn"]] },
  { id: 'C11', titulo: 'Grávida com suspeita de TVP: eco direta, sem Wells',
    ...
    passos: [["card","Suspeita de TEV"],["click","TVP"],["click","Grávida: ir diretamente"],["click","TVP proximal"],["click","Tratar em ambulatório"],["click","Enoxaparina"],["fill","pw","60"],["btnin","hbpmbtn"]] },
  ...
  { id: 'C17', titulo: 'Gravidez, TEP confirmado, 68 kg: arredondamento da dose',
    ...
    passos: [["card","Suspeita de TEV"],["click","TEP"],["click","Não, estável"],["click","Ir para a via da grávida"],["click","Sim"],["click","Negativa"],
             ["check","gy2"],["fill","gdval","1.4"],["btnin","gdbtns"],["click","Angio-TC pulmonar com protocolo"],["click","Positiva: TEP confirmado"],["fill","gw","68"],["click","Concluir: nota do episódio"]] },
  ...
  { id: 'C20', titulo: 'TVP proximal iliofemoral que justifica internamento',
    ...
    passos: [["card","TEV confirmado"],["click","TVP"],["click","TVP proximal"],["click","Internar"],["click","Enoxaparina"],["fill","pw","60"],["btnin","hbpmbtn"]] },
  ...
  { id: 'C22', titulo: 'Grávida com TEP já confirmado, entrada pelo painel do confirmado',
    caso: 'Mulher, 34 anos, 26 semanas, angio-TC já feita noutro hospital com TEP segmentar. Peso 72 kg.',
    passos: [["card","TEV confirmado"],["click","Ir para a via da grávida"],["click","TEP"],["fill","gw","72"],["click","Concluir: nota do episódio"]] },
  { id: 'C23', titulo: 'Enoxaparina escolhida no ecrã do fármaco: a nota leva a dose decidida',
    caso: 'Homem, 62 anos, 90 kg, TVP proximal, neoplasia gástrica ativa. Creatinina 1,0 mg/dL.',
    passos: [["card","TEV confirmado"],["click","TVP"],["click","TVP proximal"],["click","Tratar em ambulatório"],["click","Enoxaparina"],
             ["fill","pw","90"],["open","crclBox"],["fill","cgAge","62"],["fill","cgCr","1.0"],["radio","cgSex","M"],["btnin","hbpmbtn"]] },
  { id: 'C24', titulo: 'Alta do internado mantendo enoxaparina: dose calculada na nota',
    caso: 'Mulher, 77 anos, 58 kg, neoplasia do cólon, 4 dias de enoxaparina no internamento. Creatinina 1,4 mg/dL.',
    passos: [["hdr","Anticoagulação para casa"],["fill","aidays","4"],["click","Manter enoxaparina"],
             ["fill","pw","58"],["open","crclBox"],["fill","cgAge","77"],["fill","cgCr","1.4"],["radio","cgSex","F"],["btnin","hbpmbtn"]] },
  { id: 'C25', titulo: 'Grávida, cintigrafia como alternativa à angio-TC',
    caso: 'Mulher, 31 anos, 22 semanas, alergia grave prévia ao contraste iodado. YEARS 1, D-dímeros 1,6.',
    passos: [["card","Suspeita de TEV"],["click","TEP"],["click","Não, estável"],["click","Ir para a via da grávida"],["click","Não"],
             ["check","gy2"],["fill","gdval","1.6"],["btnin","gdbtns"],["click","Cintigrafia de perfusão"],["click","Negativa"]] },
